...
# SNU-2D-ProgrammingTools-IDE-ReStructuredText

![{Project icon} This image failed to load. It may be due to the file not being reached, or a general error. Reload the page to fix a possible general error.](/ReStructuredText_Logo.svg)
...
> [00.1 - Title](#SNU-2D-ProgrammingTools-IDE-ReStructuredText)

> [00.2 - Read this article in a different language](#Read-this-article-in-a-different-language)

> [00.3 - Index](#Index)

[01.0 - Description](#SNU_2D_ProgrammingTools_IDE_ReStructuredText)
...
# SNU_2D_ProgrammingTools_IDE_ReStructuredText
The ReStructuredText Programming language IDE submodule for SNU Programming Tools (2D Mode) 

***

## About

See above. This repository is the IDE for ReStructuredText (RST, or ReST) that comes with SNUs programming tool set.

***

## Wiki

[Click/tap here to view this projects Wiki](https://github.com/seanpm2001/SNU_2D_ProgrammingTools_IDE_ReStructuredText/wiki)
...
> * 1. [seanpm2001](https://github.com/seanpm2001/) - 19 commits (As of Monday, June 14th 2021 at 5:51 pm)
...
[Project language file](PROJECT_LANG.rst)

[Join the discussion on GitHub](https://github.com/seanpm2001/SNU_2D_ProgrammingTools_IDE_ReStructuredText/discussions)

No other resources at the moment.

This is the first time I am using ReStructuredText as a project language file, as I learned how to make the GitHub linguist recognize Markdown as a language yesterday, and I am doing a 2nd expansion to ReStructuredText. I found this out when snooping around on [Apple/Swift Evolution](https://github.com/apple/swift-evolution/blob/main/.gitattributes) if you want to do this yourself, simply add this to your `.gitattributes` file (if you haven't created one yet, make it now, do not add anything else to the file name but `.gitattributes`)
...
File version: `1 (Monday, June 14th 2021 at 5:51 pm)`
...
Version 1 (Monday, June 14th 2021 at 5:51 pm)
